...
repository_url = "https://raw.githubusercontent.com/swarthur/animedata/"
ad_table = {
    "source_file_name": "animedata_source.json",
    "local_file_name": "animedata_local.json",
    "source_file_path": os.path.join(dir_path,
                                     "resources/animedata_source.json"),
    "local_file_path": os.path.join(dir_path,
                                    "resources/animedata_local.json"),
